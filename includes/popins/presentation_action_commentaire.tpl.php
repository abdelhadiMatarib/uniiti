    ...
    <div class="presentation_action_left">
        <div class="presentation_action_left_head">
            ...
            <div class="presentation_action_left_head_categorie_wrap">    
                <span class="presentation_action_left_head_titre">Chez Les Artistes</span>
            ...
            <div class="presentation_action_left_head_note_wrap">
                <img src="<?php echo SITE_URL; ?>/img/pictos_commerces/star_0.png"/>
                <img src="<?php echo SITE_URL; ?>/img/pictos_commerces/star_0.png"/>
                <img src="<?php echo SITE_URL; ?>/img/pictos_commerces/star_0.png"/>
                <img src="<?php echo SITE_URL; ?>/img/pictos_commerces/star_0.png"/>
                <img src="<?php echo SITE_URL; ?>/img/pictos_commerces/star_0.png"/>
                <span class="presentation_action_left_head_note_txt">9/10 - 321 Avis</span>
            </div>
        ...
        <div class="presentation_action_left_body presentation_action_commentaire_left_body">
            ...
            <div class="presentation_action_commentaire_left_body_message">
                <span>5/5 | Accueil chaleureux, cadre agréable et calme. Déjeuner excellent, fin, produits de qualité bien mis en valeur, choix de vin. La musique et bonne !!! Je vais le recommander et je reviendrai sans aucun problème. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus ut diam quis erat mattis vehicula. Phasellus nisi libero, convallis vitae est vel, dapibus varius ante.Phasellus nisi libero, convallis vitae est vel, dapibus varius ante.</span>
            </div>
        ...
        <div class="presentation_action_left_footer">
            ...
            <div class="presentation_action_left_footer_timing"><span><img src="<?php echo SITE_URL; ?>/img/pictos_actions/clock.png"/>Il y a <strong>5 h</strong></span></div>
    ...
    <div class="presentation_action_right">
        ...
        <div class="presentation_action_right_suggestions">
            ...
            <div class="presentation_action_right_suggestions_content">
                <span class="presentation_action_right_suggestions_content_titre">Au bon goût de chez...</span>
            ...
            <div class="presentation_action_right_suggestions_note">
                <span class="presentation_action_right_suggestions_note_reelle">9</span>
                <span class="presentation_action_right_suggestions_note_base">/10</span>
            </div>
            <!-- FIN 1 BOX DE SUGGESTION -->
