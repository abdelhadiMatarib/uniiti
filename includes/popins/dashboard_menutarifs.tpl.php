...
<div class="menutarifs_wrapper">
    ...
    <div class="menutarifs_body">
        <div class="menutarifs_body_entrees">
            ...
            <div class="menutarifs_body_entrees_entree_generique"><span><input type="text" class="input_menustarifs" placeholder="Titre de l'entrée 1"/></span></div>
            <div class="menutarifs_body_entrees_prix_generique"><span><input type="text" maxlength=3 class="input_infos_horaires input_parking_mini" placeholder="Prix"/></span></div>
            <div class="menutarifs_body_entrees_entree_generique"><span><input type="text" class="input_menustarifs" placeholder="Titre de l'entrée 1"/></span></div>
            <div class="menutarifs_body_entrees_prix_generique"><span><input type="text" maxlength=3 class="input_infos_horaires input_parking_mini" placeholder="Prix"/></span></div>
            <div class="menutarifs_body_entrees_entree_generique"><span><input type="text" class="input_menustarifs" placeholder="Titre de l'entrée 1"/></span></div>
