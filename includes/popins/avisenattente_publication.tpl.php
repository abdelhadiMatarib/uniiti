...
<div class="suggestioncommerce_wrapper">
    ...
    <div class="suggestioncommerce_head">
        ...
        </div><span class="maintitle">Avis en attente - Publication</span>
    </div>   
    <div class="suggestioncommerce_body">
            
        <div class="suggestion_valide_txt"><span>Le commentaire de l'utilisateur est maintenant visible sur le flux de Uniiti.com</span></div>
