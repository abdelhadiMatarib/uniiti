...
<div class="suggestioncommerce_wrapper">
    ...
    <div class="suggestioncommerce_head">
        ...
        </div><span class="maintitle">Modification de votre avis</span>
    </div>   
    <div class="suggestioncommerce_body">
            
        <div class="suggestion_valide_txt"><span>Votre demande de modification a bien été prise en compte.</span></div>
