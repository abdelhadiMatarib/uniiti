		...
		<div class="dashboard_notif_item">
			<div class="dashboard_notif_item_head">
				...
				<div class="dashboard_notif_item_head_desc">
					...
					<span class="dashboard_notif_motif">Suggestion d'ajout d'objet</span>
			...
			<div class="dashboard_notif_item_body">
				<div class="dashboard_notif_item_float_left">
					<span class="dashboard_notif_txt_bold2">Nom de l'objet :</span><span class="dashboard_notif_txt_normal2"> <?php echo $nom_suggestion; ?></span>
				</div>
