...
<div class="suggestioncommerce_wrapper">
    ...
    <div class="suggestioncommerce_body">
        ...
        <div class="suggestion_valide_txt"><span>Le commentaire de l'utilisateur ainsi que votre réponse sont maintenant visibles sur le flux de Uniiti.com</span></div>
