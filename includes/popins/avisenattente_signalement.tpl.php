...
<div class="suggestioncommerce_wrapper">
    ...
    <div class="suggestioncommerce_body">
        ...
        <div class="suggestion_valide_txt"><span>Votre signalement a bien été pris en compte. Nous allons procéder à la vérification dans les plus brefs délais.</span></div>
