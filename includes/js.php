...
?>';
        var $idcontributeur = '<?php
if (isset($id_contributeur)) {
    echo $id_contributeur;
} else {
    echo '0';
}
?>';
                ...
                success : function(html){
                    if (html) {
                        ...
                        if(isJson(html)){
                            ...
                            $container.html( $(html)).isotope( 'reloadItems' ).isotope({ sortBy: 'original-order' });
...
?>';
                        ...
                        switch ($Page) {
                            ...
                            $.ajax({
                                ...
                                success: function(html){
                                    if (html) {
                                        if(($data.quoi!="" && $data.quoi!=null) || ($data.lieu!="" && $data.lieu!=null)){
                                                $container.html( $(html)).isotope( 'reloadItems' ).isotope({ sortBy: 'original-order' });
                                        }else{
