...
<!--<nav>-->
<div class="filters">
    <div class="quoideneuf_utilisateur button_moving">
		<div class="<?php if ((isset($CompteurProvenance['follow'])) && ($CompteurProvenance['follow'] > 99)) {echo $notifplus100;} else {echo $notifmoins100;}?>"><span><?php if (isset($CompteurProvenance['follow'])) {echo $CompteurProvenance['follow'];} ?></span></div>
		<a href="#" title="">Quoi de neuf ?</a>
	</div>
