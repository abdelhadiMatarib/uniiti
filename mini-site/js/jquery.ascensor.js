...
(function($, window) {
    ...
    Plugin.prototype.init = function() {
        ...
        function targetScroll(floor, time, hashChange) {
            ...
            $(".ascensorFloor").removeClass("slideActive"),
            ...
            $("#ascensorFloor" + floor).addClass("slideActive");
            // Animation du slider
            switch(floor){
                case 0:
                    $('#ascensorFloor0').css('z-index', 2);
                    $('#ascensorFloor3').css('z-index', 0);
                    $('#informations_bloc').delay(1000).animate({marginTop: "-100%"},500);
                    $('#galerie_bloc').delay(100).animate({opacity: 1}, 500);
                    break;
                case 1 :
                    $('#informations_bloc').animate({marginTop: "-3%"},1500);
                    $('#galerie_bloc').delay(100).animate({opacity: 1}, 500);
                    break;
                case 2 :
                    $('#informations_bloc').animate({marginTop: "-100%"},2500);
                    $('#galerie_bloc').delay(100).animate({opacity: 1}, 500);
                    break;
                case 3 :
                    $('#ascensorFloor3').css('z-index', 2);
                    $('#ascensorFloor0').css('z-index', 0);
                    $('#galerie_bloc').delay(3000).animate({opacity: 0}, 1500);
                    break;
                case 4 :
                    $('#galerie_bloc').delay(100).animate({opacity: 1}, 500);
                    break;
        ...
        //check key function
        function checkKey(e) {
            if ($("input, textarea, button").is(":focus"))return true;
            switch (e.which) {
              //keyDown  
                case 40:
              case 83:
