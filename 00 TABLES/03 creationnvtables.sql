...
INSERT INTO `contributeurs` (`id_contributeur`, `nom_contributeur`, `sexe_contributeur`, `slide1_contributeur`, `groupes_permissions_id_permission`, `password_contributeur`) VALUES
(0, 'Nom du contributeur', 2, 'photo 1.jpg', 1, "2bec1805cb31c4c55f61ec1bfe31fc19175e6552");
...
CREATE TABLE IF NOT EXISTS `bugs` (
  ...
  `contributeurs_id_contributeur` int(10) unsigned DEFAULT 0,
  `date_bug` datetime DEFAULT NULL,
...
--
-- Structure de la table `objets_labelsuniiti`
--

CREATE TABLE IF NOT EXISTS `objets_labelsuniiti` (
  `objets_id_objet` int(10) unsigned NOT NULL,
  `id_label` int(10) unsigned NOT NULL,
  PRIMARY KEY (`objets_id_objet`, `id_label`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ;
...
--
-- Structure de la table `objets_recommandations`
--

CREATE TABLE IF NOT EXISTS `objets_recommandations` (
  `objets_id_objet` int(10) unsigned NOT NULL,
  `id_recommandation` int(10) unsigned NOT NULL,
  PRIMARY KEY (`objets_id_objet`, `id_recommandation`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ;
...
CREATE TABLE IF NOT EXISTS `objets` (
  ...
  `villes_id_ville` int(10) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `objets` (`id_objet`, `nom_objet`, `villes_id_ville`, `box_objet`, `slide1_objet`, `sscategorie_objet`) VALUES
(0, 'Nom de l''objet', 1, 'photo 1.jpg', 'photo 1.jpg', 1);

-- --------------------------------------------------------

--
-- Structure de la table `avis_objet`
--

CREATE TABLE IF NOT EXISTS `avis_objet` (
  `id_avis` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `appreciation` tinyint(4) DEFAULT NULL,
  `note` decimal(3,1) unsigned DEFAULT NULL,
  `commentaire` text,
  `origine` varchar(10) DEFAULT NULL,
  `date_avis` datetime DEFAULT NULL,
  `rester_contact` tinyint(1) DEFAULT NULL,
  `id_statut` int(10) unsigned NOT NULL DEFAULT 2,
  PRIMARY KEY (`id_avis`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Structure de la table `objets_recoient_avis`
--

CREATE TABLE IF NOT EXISTS `objets_recoient_avis` (
  `objets_id_objet` int(10) unsigned NOT NULL,
  `avis_id_avis` int(10) unsigned NOT NULL,
  PRIMARY KEY (`avis_id_avis`,`objets_id_objet`),
  KEY `fk_objets_has_avis_avis1` (`avis_id_avis`),
  KEY `fk_objets_has_avis_objets1` (`objets_id_objet`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Contraintes pour la table `objets_recoient_avis`
--
ALTER TABLE `objets_recoient_avis`
  ADD CONSTRAINT `fk_objets_has_avis_avis1` FOREIGN KEY (`avis_id_avis`) REFERENCES `avis_objet` (`id_avis`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_objets_has_avis_objets1` FOREIGN KEY (`objets_id_objet`) REFERENCES `objets` (`id_objet`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- --------------------------------------------------------

--
-- Structure de la table `contributeurs_donnent_avis_objet`
--

CREATE TABLE IF NOT EXISTS `contributeurs_donnent_avis_objet` (
  `contributeurs_id_contributeur` int(10) unsigned NOT NULL,
  `avis_id_avis` int(10) unsigned NOT NULL,
  PRIMARY KEY (`avis_id_avis`,`contributeurs_id_contributeur`),
  KEY `fk_contributeurs_has_avis_avis2` (`avis_id_avis`),
  KEY `fk_contributeurs_has_avis_contributeurs2` (`contributeurs_id_contributeur`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Contraintes pour la table `contributeurs_donnent_avis_objet`
--
ALTER TABLE `contributeurs_donnent_avis_objet`
  ADD CONSTRAINT `fk_contributeurs_has_avis_avis2` FOREIGN KEY (`avis_id_avis`) REFERENCES `avis_objet` (`id_avis`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_contributeurs_has_avis_contributeurs2` FOREIGN KEY (`contributeurs_id_contributeur`) REFERENCES `contributeurs` (`id_contributeur`) ON DELETE NO ACTION ON UPDATE NO ACTION;

  
-- --------------------------------------------------------

--
-- Structure de la table `contributeurs_avis_utiles_objet`
--

CREATE TABLE IF NOT EXISTS `contributeurs_avis_utiles_objet` (
...
--
-- Structure de la table `objets_prestations`
--

CREATE TABLE IF NOT EXISTS `objets_prestations` (
  `objets_id_objet` int(10) unsigned NOT NULL,
  `id_type_info` int(10) unsigned NOT NULL,
  `prestation` varchar(45) NOT NULL,
  PRIMARY KEY (`objets_id_objet`, `id_type_info`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT = 1;
...
--
-- Structure de la table `objets_prestations_contenus`
--

CREATE TABLE IF NOT EXISTS `objets_prestations_contenus` (
  `id_contenu` int(10) unsigned NOT NULL,
  `objets_id_objet` int(10) unsigned NOT NULL,
  `id_type_info` int(10) unsigned NOT NULL,
  `contenu` varchar(45) NOT NULL,
  `prix` decimal(5,2) NOT NULL,
  PRIMARY KEY (`id_contenu`, `objets_id_objet`, `id_type_info`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Structure de la table `objets_motscles`
--

CREATE TABLE IF NOT EXISTS `objets_infos_motscles` (
  `objets_id_objet` int(10) unsigned NOT NULL,
  `id_type_info` int(10) unsigned NOT NULL,
  `id_motcle1` int(10) unsigned NOT NULL,
  `id_motcle2` int(10) unsigned NOT NULL,
