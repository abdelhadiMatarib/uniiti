...
<div class="box_petit_mot">
    <div class="box_petit_mot_modif_icon">
        <img src="../img/pictos_utilisateurs/interface_crayon_icon_b.png" title="" alt="" />
    </div>
    <div class="box_petit_mot_titre">
        <img src="../img/pictos_commerces/icon_plume_petitmot.png" title="" alt="" />
        <span>Le petit mot du commerçant</span>
    </div>
    <div class="box_petit_mot_content">
        <p class="box_petit_mot_content_txt">
           Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam id purus sapien. 
           Sed vestibulum tincidunt turpis sit amet tincidunt. Duis ultrices augue non bibendum sagittis.
           Sed vestibulum tincidunt turpis sit amet tincidunt. Duis ultrices augue non bibendum sagittis.
        </p>
    </div>
</div>
...
<div class="commerce_couv">
    ...
    <div class="commerce_couv_video_bg">
        <div class="commerce_couv_video_embbed">
            <iframe width="660" height="496" src="//www.youtube.com/embed/65yIGcqj5S8" frameborder="0" allowfullscreen></iframe>
        </div>
    </div>
...
<h1>LISTE GMAP RESEAU DE COMMERCES</h1>
<!-- Google Map -->
