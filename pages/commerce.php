        ...
        <div class="big_wrapper" id="test">
            ...
            <div class="commerce_head">
                <div class="commerce_head_desc">
                    ...
                    <div class="clearfix"></div>
                    <div class="commerce_head_desc_address"><div class="img_container" id="commerce_head_desc_address_button"><img src="<?php echo SITE_URL; ?>/img/marker_map.png" title="" alt="" height="23" width="15"/></div><div id="commerce_head_desc_address_wrap" title="Visualiser sur la carte"><address><?php echo $adresse1_enseigne; ?></address><span><?php echo $code_postal; ?> <?php echo $ville_enseigne; ?></span></div></div>
                    <div class="commerce_head_desc_ariane"><div class="img_container" id="commerce_head_desc_ariane_button"><img src="<?php echo SITE_URL; ?>/img/pictos_commerces/etiquette.png" title="" alt="" height="20" width="23" /></div><div id="commerce_head_desc_ariane_wrap" title="Commerce - <?php echo $categorie; ?> - <?php echo $sous_categorie; ?> - <?php echo $sous_categorie2; ?>"><span>Commerce - <?php echo $categorie; ?> - <?php echo $sous_categorie; ?></span><span class="commerce_head_desc_ariane_lastcat"> - <?php echo $sous_categorie2; ?></span></div></div>
                    <div class="clearfix"></div>
                    <div class="separateur"></div>
                    <div class="clearfix"></div>
                    <div class="commerce_head_desc_identity"><div class="img_container" id="commerce_head_desc_identity_button"><img src="<?php echo SITE_URL; ?>/img/pictos_commerces/identity.png" title="" alt="" height="18" width="22" /></div><div id="commerce_head_desc_identity_wrap"><span><?php if ($telephone_enseigne) echo 'Tél. : ';echo chunk_split($telephone_enseigne,2,'.');?></span><a href="#" title=""><?php echo $url; ?></a></div></div>
                    <div class="commerce_head_desc_prices">
						<div class="img_container" id="commerce_head_desc_prices_button"><img src="<?php echo SITE_URL; ?>/img/pictos_commerces/price.png" title="<?php echo $budget; ?>" alt="" height="21" width="21" /></div>
