          ...
          <div class="liseret_bleu"></div>
            ...
            <div class="inscription_centres_interets_big_wrap">
             ...
             <div class="inscription_centres_interets_aime_wrap2">
                 ...
                 <ul>
                    <li><img src="<?php echo SITE_URL; ?>/img/pictos_inscription/choix_centresinterets.png" height="37" width="45" title="" alt=""/></li>
                    <li><img src="<?php echo SITE_URL; ?>/img/pictos_inscription/choix_centresinterets.png" height="37" width="45" title="" alt=""/></li>
                    <li><img src="<?php echo SITE_URL; ?>/img/pictos_inscription/choix_centresinterets.png" height="37" width="45" title="" alt=""/></li>
                    <li><img src="<?php echo SITE_URL; ?>/img/pictos_inscription/choix_centresinterets.png" height="37" width="45" title="" alt=""/></li>
                    <li><img src=".<?php echo SITE_URL; ?>/img/pictos_inscription/choix_centresinterets.png" height="37" width="45" title="" alt=""/></li>
            ...
            <div class="inscription_next_step2">
                ...
                <div class="inscription_next_step_button2"><a href="#" onclick="ActualisePopin({}, '/pages/inscription3b.php', 'default_dialog_inscription');" title="">Suivant</a></div>
