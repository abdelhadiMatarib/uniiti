...
$('.load_sugg_commerce').click(function(e){
    e.preventDefault();
   $('.dashboard_load_notifs').load('../includes/popins/dashboard_gestion_commerce_suggestions.tpl.php').slideUp().slideDown();
});
$('.load_notif_commerce').click(function(e){
    e.preventDefault();
   $('.dashboard_load_notifs').load('../includes/popins/dashboard_gestion_commerce_notifications.tpl.php').slideUp().slideDown();
});
</script>
