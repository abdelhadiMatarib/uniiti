...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="big_wrapper">
            ...
            <div class="inscription_fields_left">
                <div class="inscription_upload_image_container"><input id="inscription_upload" type="file" /></div>
            </div>
            <div class="inscription_fields_right">
            ...
            <div class="inscription_next_step2">
                ...
                <div class="inscription_next_step_button2"><a href="#" title="">Suivant</a></div>
            </div>
