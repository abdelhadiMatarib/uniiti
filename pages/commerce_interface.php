    ...
    <body>
        ...
        <div class="big_wrapper" id="test">
            ...
            <div class="commerce_head2">
				...
				<div class="commerce_head2_reseau_interface" onclick="<?php echo $AjoutReseau; ?>"><span class="commerce_head2_text1">Votre</span><span class="commerce_head2_text2" style="color:<?php echo $couleur; ?>;">Réseau</span><div class="img_container"><img src="<?php echo SITE_URL; ?>/img/pictos_commerces/reseau.png" alt="" title="" height="19" width="19" /></div><div class="commerce_head2_text3"><span><?php echo $count_reseau; ?></span></div><?php if ($count_reseau_attente > 0) { ?><div class="notifs_reseau"><span><?php echo $count_reseau_attente; ?></span></div><?php } ?></div>
