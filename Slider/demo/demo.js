...
$(function(){
	...
	$('#slider-one').movingBoxes({
		...
		width        : 460,    // overall width of movingBoxes (not including navigation arrows)
		panelWidth   : .35,     // current panel width adjusted to 70% of overall width
		buildNav     : true,
		fixedHeight  : false,// if true, navigation links will be added
