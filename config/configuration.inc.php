<?php
define ("CHEMIN_LOCAL", "/uniiti");
define ("SITE_URL", "http://127.0.0.1" . CHEMIN_LOCAL);

define ("ROOT_CHEMIN_LOCAL", "C:/Users/Francois/Documents/GitHub" . CHEMIN_LOCAL);
...
define ("ROOT_ENSEIGNES_BOX", ROOT_CHEMIN_LOCAL . "/photos/enseignes/box/");
define ("SITE_ENSEIGNES_BOX", SITE_URL . "/photos/enseignes/box/");
define ("ROOT_OBJETS_COUV", ROOT_CHEMIN_LOCAL . "/photos/objets/couvertures/");
define ("SITE_OBJETS_COUV", SITE_URL . "/photos/objets/couvertures/");
define ("ROOT_OBJETS_BOX", ROOT_CHEMIN_LOCAL . "/photos/objets/box/");
define ("SITE_OBJETS_BOX", SITE_URL . "/photos/objets/box/");
